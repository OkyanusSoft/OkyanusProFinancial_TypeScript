...
export const SYSTEM = {
  ...
  help: "https://help.okyanussoft.online",
  author: "المهندس وائل عبدالله الشرفي",
  authorRole: "تحليل وتصميم وتطوير وإعداد",
};
...
export const CHANGELOG = [
  { v: "6.1.0", date: "2026-09-14", tag: "إصدار رئيسي", items: [
    "تحديث شامل للوثائق: دليل النشر والتثبيت DEPLOY.md وREADME.md ودليل المستخدم",
    "ربط زر الدعم الفني بمركز المساعدة help.okyanussoft.online",
    "توثيق تحليل وتصميم وتطوير النظام باسم المهندس وائل عبدالله الشرفي",
    "سجل تغييرات موسّع يغطي كامل رحلة النظام من v1.0 حتى v6.1.0",
  ]},
  { v: "6.0.0", date: "2026-08-02", tag: "تجربة المستخدم", items: [
    "تحويل كل أزرار الإجراءات إلى أيقونات مربعة ملوّنة في صف واحد متناسق",
    "شاشة عرض المستند للقراءة فقط مع القيد المحاسبي المولّد تلقائياً",
    "سير حالة موحّد لكل المستندات: مسودة ← مرحّل مع إلغاء ترحيل للمدير",
    "الحذف النهائي بنقرتين (تأكيد) يختفي من السجل نهائياً",
    "إصلاح تعليق زر الإضافة في المبيعات والمشتريات والحسابات (الحجز الكسول للأرقام)",
  ]},
  { v: "5.2.0", date: "2026-06-21", tag: "التنظيم والإدارة", items: [
    "قسم الشركات والفروع في الإعدادات العامة مع سجل شركات ديناميكي",
    "شاشة الدخول تقرأ الشركات والفروع من السجلات الحية",
    "نقل الهيكل الإداري إلى الموارد البشرية: الإدارات والأقسام المرتبطة",
    "الوكيل الذكي: تشخيص ذاتي للمنظومة مع إصلاح تلقائي",
  ]},
  { v: "5.0.0", date: "2026-05-10", tag: "إعدادات متقدمة", items: [
    "قسم إعدادات التقارير: الهوية والترويسة والتنسيق والألوان والختم والاعتمادات",
    "10 أنماط مظهر احترافية + 11 خلفية شريط جانبي + 10 مشاهد لشاشة الدخول",
    "درجة وضوح الخط بتقنيات CSS حقيقية ومعاينة حية",
    "إعدادات قاعدة البيانات: اتصال MySQL وحالة التشغيل وخطوات التفعيل وملفات الحزمة",
    "استعادة البيانات الافتراضية المعتمدة مع بث جيل المزامنة لكل الأجهزة",
  ]},
  { v: "4.2.0", date: "2026-04-05", tag: "المحاسبة العميقة", items: [
    "سند قبض وصرف بحقول رأس وبنود احترافية مع طباعة مستندية",
    "تقرير حركة القيود لكل القيود المولّدة من النظام المحاسبي",
    "ربط مجموعات الأصناف بالحسابات المحاسبية (مخزون/تكلفة/مبيعات)",
    "حقل البيان الكبير الموحد في كل مستندات الحركات",
    "إقفال الفترات يمنع الترحيل وإلغاء الترحيل",
  ]},
  { v: "4.0.0", date: "2026-03-29", tag: "إصدار رئيسي", items: [
    "إعادة تسمية النظام إلى «النظام المالي المتكامل» مع هوية بصرية وأيقونة مالية",
    "21 نظاماً متخصصاً مفعّلاً من شاشة واحدة برقم سري للمالك",
    "قاعدة بيانات تكيفية بجداول مرنة (JSON) دون تغيير المخطط",
    "هيكلة قوائم من ثلاثة مستويات تغطي كل شاشة وتقاريرها",
    "توليد أرقام تلقائي + استيراد CSV مع معاينة + سلة محذوفات",
  ]},
  { v: "3.1.0", date: "2026-02-15", tag: "معمارية ومزامنة", items: [
    "الخادم المركزي: Express + MySQL 8 + WebSocket مع JWT وRate Limiting",
    "نظام Migrations مرقّم آمن للتكرار لأي جدول أو عمود",
    "مزامنة دمج مركزي لحظية (الأحدث يفوز — لا حذف لبيانات أي جهاز)",
    "نشر الحذف عبر Tombstones + الاستبدال الشامل عبر رقم الجيل Gen",
    "شاشة فحص التزامن والحمل لـ100 مستخدم متزامن + هوية جهاز ثابتة",
  ]},
  { v: "3.0.0", date: "2026-01-18", tag: "الموارد والأصول", items: [
    "نظام الموارد البشرية: الموظفون والحضور والمكافآت والإنذارات والإجازات وكشوف الرواتب المرحّلة",
    "نظام الأصول الثابتة مع إهلاك القسط الثابت وقيدة السنوية",
    "نظام نقاط البيع المتكيف (متاجر تجزئة / مطاعم)",
    "لوحة تحكم بنبض النشاط والإحصاءات الحية",
  ]},
  ...
  { v: "2.9.0", date: "2025-08-20", tag: "ميزات جديدة", items: ["سندات التحويل بين المخازن مع تسعير تلقائي", "حدود ائتمانية للعملاء مع تنبيهات فورية", "تصدير التقارير إلى Excel وPDF"] },
  ...
  { v: "2.0.0", date: "2025-01-30", tag: "إصدار رئيسي", items: [
    "الأنظمة الأساسية: المخازن والمشتريات والمبيعات والحسابات العامة",
    "القيد المزدوج متعدد العملات مع التحقق من التوازن",
    "دليل الحسابات والحسابات التحليلية ومراكز التكلفة",
    "تقارير ميزان المراجعة وميزان العمومية وقائمة الدخل بمعايير IFRS",
  ]},
  { v: "1.0.0", date: "2025-01-05", tag: "الإطلاق الأول", items: [
    "إطلاق النواة الأولى للنظام المالي",
    "قاعدة البيانات الأساسية وهيكل الجداول والعلاقات والمحفزات",
    "واجهة تسجيل الدخول والقائمة الرئيسية",
    "أساسيات دليل الحسابات والقيود اليومية",
  ]},
];
