/* ════════════════════════════════════════════════════════════
   OkyanusProERP 3.0 — نماذج البيانات والبيانات الأولية (Seed Data)
   طبقة البيانات منفصلة تماماً عن العرض (Data Access Layer)
   ════════════════════════════════════════════════════════════ */
...
export interface Item { code: string; name: string; group: string; unit: string; barcode: string; cost: number; price: number; min: number; max: number; qty: Record<string, number> }
export interface InvDoc { id: string; type: "افتتاحي" | "توريد" | "صرف" | "تحويل" | "تسوية" | "جرد"; date: string; ref: string; warehouse: string; toWarehouse?: string; user: string; status: "مرحّل" | "ملغي"; lines: { item: string; qty: number; cost: number }[]; note?: string }
export interface Partner { code: string; name: string; phone: string; city: string; category: string; balance: number; creditLimit?: number; account: string }
export interface Invoice { id: string; no: string; date: string; partner: string; payType: "نقدي" | "آجل"; currency: string; rate: number; costCenter: string; status: "مرحّلة" | "ملغاة"; lines: { item: string; qty: number; price: number; disc: number }[]; vat: number; note?: string }
export interface Quote { id: string; no: string; date: string; partner: string; valid: string; total: number; status: "ساري" | "مقبول" | "مرفوض" | "منتهي" }
...
export interface User { id: string; name: string; username: string; role: string; branch: string; active: boolean; lastLogin: string }
...
export const ACCOUNTS: Account[] = [
  ...
  { code: "11122", name: "بنك التضامن — توفير", en: "Tadhamon Bank - Saving", level: 5, parent: "1112", type: "أصول", posting: true },
  ...
  { code: "1142", name: "مجمعات الاستهلاك", en: "Accumulated Depreciation", level: 4, parent: "114", type: "أصول", posting: false },
  ...
  { code: "21211", name: "ضريبة مبيعات مستحقة", en: "Output VAT", level: 5, parent: "2121", type: "خصوم", posting: true },
  ...
  { code: "5131", name: "استهلاك أصول ثابتة", en: "Fixed Assets Depreciation", level: 4, parent: "513", type: "مصروفات", posting: false },
  { code: "51311", name: "استهلاك المعدات الطبية", en: "Medical Equip. Depreciation", level: 5, parent: "5131", type: "مصروفات", posting: true },
...
/* ── الحسابات التحليلية (مرتبطة بالحساب 11212 نزلاء المستشفى) ── */
export const ANALYTICALS = [
  { id: "AN-001", name: "أحمد محمد الشامي", linkedAccount: "11212", open: 40000, debit: 22000, credit: 0, phone: "777-102-334", note: "قسم الباطنية — غرفة 204" },
  { id: "AN-002", name: "سالم عبدالله الحضرمي", linkedAccount: "11212", open: 35000, debit: 13500, credit: 0, phone: "733-881-210", note: "قسم الجراحة — غرفة 118" },
  { id: "AN-003", name: "منى عوض السقاف", linkedAccount: "11212", open: 30000, debit: 9000, credit: 0, phone: "711-455-902", note: "قسم النساء — غرفة 305" },
  { id: "AN-004", name: "خالد سالم باوزير", linkedAccount: "11212", open: 25000, debit: 500, credit: 0, phone: "770-233-481", note: "قسم الأطفال — غرفة 210" },
  { id: "AN-005", name: "فاطمة حسن العمودي", linkedAccount: "11212", open: 50000, debit: 0, credit: 0, phone: "736-604-118", note: "قسم العيون — غرفة 122" },
];

export const UNITS = ["قطعة", "علبة", "كرتون", "كيلوجرام", "لتر", "أمبولة", "شريط"];
export const GROUPS = ["مضادات حيوية", "مسكنات وخافضات حرارة", "فيتامينات ومكملات", "مستلزمات طبية", "محاليل وحقن", "أجهزة قياس"];
export const WAREHOUSES = [
  { code: "WH-01", name: "المخزن الرئيسي — صنعاء", keeper: "عادل الحميري", capacity: "12,000 موقع" },
  { code: "WH-02", name: "مخزن الفرع — عدن", keeper: "سميرة النجار", capacity: "4,500 موقع" },
  { code: "WH-03", name: "مخزن العبور — المكلا", keeper: "فهد باشراحيل", capacity: "2,200 موقع" },
];

export const ITEMS: Item[] = [
  { code: "IT-1001", name: "باراسيتامول 500mg أقراص", group: "مسكنات وخافضات حرارة", unit: "علبة", barcode: "6210001001", cost: 850, price: 1150, min: 200, max: 2000, qty: { "WH-01": 1240, "WH-02": 320 } },
  { code: "IT-1002", name: "أموكسيسيلين 500mg كبسول", group: "مضادات حيوية", unit: "علبة", barcode: "6210001002", cost: 1450, price: 1980, min: 150, max: 1500, qty: { "WH-01": 860, "WH-02": 140, "WH-03": 90 } },
  { code: "IT-1003", name: "فيتامين C + زنك فوار", group: "فيتامينات ومكملات", unit: "علبة", barcode: "6210001003", cost: 1100, price: 1500, min: 100, max: 900, qty: { "WH-01": 640 } },
  { code: "IT-1004", name: "سيفترياكسون 1g حقن", group: "محاليل وحقن", unit: "أمبولة", barcode: "6210001004", cost: 2200, price: 2950, min: 300, max: 2500, qty: { "WH-01": 260, "WH-02": 120 } },
  { code: "IT-1005", name: "محلول نورمال سالين 500ml", group: "محاليل وحقن", unit: "قطعة", barcode: "6210001005", cost: 620, price: 890, min: 400, max: 3000, qty: { "WH-01": 2100, "WH-02": 800, "WH-03": 350 } },
  { code: "IT-1006", name: "جهاز قياس ضغط رقمي", group: "أجهزة قياس", unit: "قطعة", barcode: "6210001006", cost: 18500, price: 24900, min: 20, max: 150, qty: { "WH-01": 46 } },
  { code: "IT-1007", name: "قفازات طبية معقمة (100)", group: "مستلزمات طبية", unit: "علبة", barcode: "6210001007", cost: 1900, price: 2600, min: 250, max: 2200, qty: { "WH-01": 180, "WH-02": 95 } },
  { code: "IT-1008", name: "أوميغا 3 كبسولات 1000mg", group: "فيتامينات ومكملات", unit: "علبة", barcode: "6210001008", cost: 3400, price: 4500, min: 80, max: 700, qty: { "WH-01": 420, "WH-02": 110 } },
  { code: "IT-1009", name: "أنسولين مخلوط 100IU", group: "محاليل وحقن", unit: "أمبولة", barcode: "6210001009", cost: 5600, price: 7200, min: 120, max: 800, qty: { "WH-01": 95, "WH-03": 40 } },
  { code: "IT-1010", name: "جهاز قياس سكر + شرائط", group: "أجهزة قياس", unit: "قطعة", barcode: "6210001010", cost: 14200, price: 19400, min: 25, max: 180, qty: { "WH-01": 58, "WH-02": 22 } },
];

export const SUPPLIERS: Partner[] = [
  { code: "SP-01", name: "شركة الدواء الحديث المتحدة", phone: "01-448-210", city: "صنعاء", category: "أدوية", balance: 342000, account: "21111" },
  { code: "SP-02", name: "مؤسسة الخليج للمستلزمات الطبية", phone: "02-331-908", city: "عدن", category: "مستلزمات", balance: 128500, account: "21111" },
  { code: "SP-03", name: "شركة ميديكال بلس للتجهيزات", phone: "05-662-774", city: "المكلا", category: "أجهزة", balance: 0, account: "21111" },
  { code: "SP-04", name: "مختبرات فارما كير", phone: "01-220-315", city: "صنعاء", category: "تحاليل", balance: 56800, account: "21111" },
];

export const CUSTOMERS: Partner[] = [
  { code: "CU-01", name: "مستشفى النور التخصصي", phone: "01-505-100", city: "صنعاء", category: "مستشفيات", balance: 412000, creditLimit: 500000, account: "11211" },
  { code: "CU-02", name: "صيدلية الشفاء المركزية", phone: "02-244-871", city: "عدن", category: "صيدليات", balance: 96400, creditLimit: 150000, account: "11211" },
  { code: "CU-03", name: "مؤسسة الصحة للجميع", phone: "05-310-226", city: "المكلا", category: "منظمات", balance: 188200, creditLimit: 200000, account: "11211" },
  { code: "CU-04", name: "مجمع الريان الطبي", phone: "01-617-402", city: "تعز", category: "مجمعات", balance: 64300, creditLimit: 120000, account: "11211" },
  { code: "CU-05", name: "صيدلية ابن سينا", phone: "02-883-519", city: "عدن", category: "صيدليات", balance: 210500, creditLimit: 200000, account: "11211" },
];

export const INV_DOCS: InvDoc[] = [
  { id: "INV-2601", type: "افتتاحي", date: "2026-01-01", ref: "OB-2026", warehouse: "WH-01", user: "عادل الحميري", status: "مرحّل", lines: [{ item: "IT-1001", qty: 1240, cost: 850 }, { item: "IT-1002", qty: 860, cost: 1450 }, { item: "IT-1005", qty: 2100, cost: 620 }], note: "أرصدة افتتاحية للمخزن الرئيسي" },
  { id: "INV-2602", type: "توريد", date: "2026-01-14", ref: "GRN-0114", warehouse: "WH-01", user: "عادل الحميري", status: "مرحّل", lines: [{ item: "IT-1004", qty: 260, cost: 2200 }, { item: "IT-1007", qty: 180, cost: 1900 }], note: "توريد من شركة الدواء الحديث" },
  { id: "INV-2603", type: "تحويل", date: "2026-01-28", ref: "TR-0007", warehouse: "WH-01", toWarehouse: "WH-02", user: "فهد باشراحيل", status: "مرحّل", lines: [{ item: "IT-1001", qty: 320, cost: 850 }, { item: "IT-1005", qty: 800, cost: 620 }] },
  { id: "INV-2604", type: "صرف", date: "2026-02-06", ref: "ISS-0021", warehouse: "WH-01", user: "عادل الحميري", status: "مرحّل", lines: [{ item: "IT-1003", qty: 120, cost: 1100 }], note: "صرف لفرع عدن — حملة ترويجية" },
  { id: "INV-2605", type: "جرد", date: "2026-02-20", ref: "JC-0001", warehouse: "WH-02", user: "سميرة النجار", status: "مرحّل", lines: [{ item: "IT-1002", qty: -6, cost: 1450 }, { item: "IT-1007", qty: 4, cost: 1900 }], note: "فروقات الجرد الدوري — فبراير" },
  { id: "INV-2606", type: "تسوية", date: "2026-03-05", ref: "ADJ-0003", warehouse: "WH-01", user: "عادل الحميري", status: "ملغي", lines: [{ item: "IT-1008", qty: -12, cost: 3400 }], note: "أُلغي بخطأ إدخال — أعيد إنشاؤه" },
];

export const PURCHASES: Invoice[] = [
  { id: "PU-1", no: "PIN-2026-0087", date: "2026-01-12", partner: "SP-01", payType: "آجل", currency: "YER", rate: 1, costCenter: "CC-01", status: "مرحّلة", vat: 5, lines: [{ item: "IT-1004", qty: 260, price: 2200, disc: 0 }, { item: "IT-1001", qty: 400, price: 850, disc: 2 }] },
  ...
  { id: "PU-3", no: "PIN-2026-0096", date: "2026-02-09", partner: "SP-03", payType: "آجل", currency: "USD", rate: 535, costCenter: "CC-02", status: "مرحّلة", vat: 5, lines: [{ item: "IT-1006", qty: 20, price: 34.5, disc: 0 }, { item: "IT-1010", qty: 15, price: 26.5, disc: 0 }] },
...
export const SALES: Invoice[] = [
  { id: "SA-1", no: "SIN-2026-0201", date: "2026-01-08", partner: "CU-01", payType: "آجل", currency: "YER", rate: 1, costCenter: "CC-01", status: "مرحّلة", vat: 5, lines: [{ item: "IT-1001", qty: 150, price: 1150, disc: 0 }, { item: "IT-1005", qty: 400, price: 890, disc: 2 }] },
...
export const QUOTES: Quote[] = [
  { id: "Q-1", no: "QT-2026-0041", date: "2026-03-02", partner: "CU-03", valid: "2026-03-31", total: 1180000, status: "مقبول" },
  { id: "Q-2", no: "QT-2026-0044", date: "2026-03-10", partner: "CU-01", valid: "2026-04-10", total: 642500, status: "ساري" },
  { id: "Q-3", no: "QT-2026-0047", date: "2026-03-18", partner: "CU-05", valid: "2026-04-18", total: 288300, status: "ساري" },
  { id: "Q-4", no: "PQ-2026-0019", date: "2026-03-06", partner: "SP-01", valid: "2026-03-25", total: 954000, status: "منتهي" },
  { id: "Q-5", no: "PQ-2026-0022", date: "2026-03-16", partner: "SP-03", valid: "2026-04-15", total: 213000, status: "ساري" },
];

export const COST_CENTERS = [
  { code: "CC-01", name: "الإدارة العامة", parent: "", manager: "م. أروى المقطري" },
  { code: "CC-02", name: "فرع عدن", parent: "", manager: "أ. نبيل السباعي" },
  { code: "CC-03", name: "فرع المكلا", parent: "", manager: "أ. فهد باشراحيل" },
  { code: "CC-011", name: "قسم المشتريات", parent: "CC-01", manager: "أ. هدى العامري" },
  { code: "CC-012", name: "قسم المبيعات", parent: "CC-01", manager: "أ. طارق الوزير" },
  { code: "CC-021", name: "صيدلية الفرع", parent: "CC-02", manager: "د. لمى العطاس" },
];

export const CURRENCIES = [
  { code: "YER", name: "الريال اليمني", symbol: "ر.ي", rate: 1, base: true },
  { code: "USD", name: "الدولار الأمريكي", symbol: "$", rate: 535, base: false },
  { code: "SAR", name: "الريال السعودي", symbol: "ر.س", rate: 142.7, base: false },
  { code: "EUR", name: "اليورو", symbol: "€", rate: 578.4, base: false },
];

export const PERIODS = [
  { id: "2026-01", label: "يناير 2026", locked: true, closedAt: "2026-02-03" },
  { id: "2026-02", label: "فبراير 2026", locked: true, closedAt: "2026-03-04" },
  { id: "2026-03", label: "مارس 2026", locked: false, closedAt: "" },
  { id: "2026-04", label: "أبريل 2026", locked: false, closedAt: "" },
  { id: "2026-05", label: "مايو 2026", locked: false, closedAt: "" },
  { id: "2026-06", label: "يونيو 2026", locked: false, closedAt: "" },
];

/* ── قيود اليومية (قيد مزدوج متوازن تماماً) ── */
export const JOURNALS: Journal[] = [
  { id: "JE-0001", no: "FYE-2026-001", date: "2026-01-01", desc: "القيد الافتتاحي للسنة المالية 2026", kind: "افتتاحي", user: "سمير الحداد", status: "مرحّل", source: "سند قيد افتتاحي", lines: [
  ...
  { id: "JE-1001", no: "JE-2026-1001", date: "2026-01-15", desc: "مبيعات نقدية — فاتورة SIN-2026-0201 وما يليها", kind: "يومية", user: "سمير الحداد", status: "مرحّل", source: "فاتورة مبيعات", lines: [
  ...
  { id: "JE-1002", no: "JE-2026-1002", date: "2026-01-22", desc: "مبيعات آجلة — مستشفى النور ومجمع الريان", kind: "يومية", user: "سمير الحداد", status: "مرحّل", source: "فاتورة مبيعات", lines: [
  ...
  { id: "JE-1003", no: "JE-2026-1003", date: "2026-02-03", desc: "فاتورة مشتريات آجلة — شركة الدواء الحديث", kind: "يومية", user: "هدى العامري", status: "مرحّل", source: "فاتورة مشتريات", lines: [
    ...
    { account: "21111", debit: 0, credit: 154000, currency: "YER", rate: 1 },
  ]},
  { id: "JE-1004", no: "JE-2026-1004", date: "2026-02-10", desc: "مسيرات رواتب شهر يناير 2026", kind: "صرف", user: "سمير الحداد", status: "مرحّل", source: "سند صرف", lines: [
  ...
  { id: "JE-1007", no: "JE-2026-1007", date: "2026-03-11", desc: "إيجار المقر الرئيسي — الربع الأول", kind: "يومية", user: "سمير الحداد", status: "مرحّل", source: "فاتورة مصروف", lines: [
  ...
  { id: "JE-1008", no: "JE-2026-1008", date: "2026-03-20", desc: "قسط استهلاك المعدات الطبية — مارس", kind: "يومية", user: "سمير الحداد", status: "مرحّل", source: "قيد تسوية", lines: [
  ...
  { id: "JE-1009", no: "JE-2026-1009", date: "2026-03-25", desc: "خدمات طبية لنزلاء — تحليلي: أحمد الشامي وسالم الحضرمي", kind: "يومية", user: "سمير الحداد", status: "مرحّل", source: "فاتورة خدمات", lines: [
    { account: "11212", debit: 45000, credit: 0, currency: "YER", rate: 1, analytical: "AN-001" },
    { account: "11212", debit: 0, credit: 0, currency: "YER", rate: 1, analytical: "AN-002" },
    { account: "41211", debit: 0, credit: 45000, currency: "YER", rate: 1, costCenter: "CC-021" },
  ]},
  { id: "JE-1010", no: "REQ-2026-0004", date: "2026-03-27", desc: "طلب قيد — حملة تسويق رقمية (بانتظار موافقة المدير المالي)", kind: "طلب", user: "طارق الوزير", status: "بانتظار الموافقة", source: "طلب سند قيد", lines: [
...
export const USERS: User[] = [
  { id: "U-01", name: "م. أروى المقطري", username: "admin", role: "مدير النظام", branch: "المركز الرئيسي", active: true, lastLogin: "2026-03-29 08:12" },
  { id: "U-02", name: "سمير الحداد", username: "s.haddad", role: "محاسب رئيسي", branch: "المركز الرئيسي", active: true, lastLogin: "2026-03-29 07:55" },
  { id: "U-03", name: "عادل الحميري", username: "a.humairi", role: "أمين مخزن", branch: "المركز الرئيسي", active: true, lastLogin: "2026-03-28 16:40" },
  { id: "U-04", name: "هدى العامري", username: "h.ameri", role: "مسؤولة مشتريات", branch: "فرع عدن", active: true, lastLogin: "2026-03-29 09:03" },
  { id: "U-05", name: "طارق الوزير", username: "t.wazir", role: "مسؤول مبيعات", branch: "فرع عدن", active: false, lastLogin: "2026-03-14 11:22" },
];
...
export const CHANGELOG = [
  { v: "3.0.0", date: "2026-01-15", tag: "إصدار رئيسي", items: ["إطلاق الحسابات التحليلية المرتبطة بالمستوى الخامس", "خمسة أنماط مظهر احترافية مع وضع ليلي كامل", "محرك قيد مزدوج متعدد العملات مع التحقق الفوري من التوازن", "إعادة هيكلة قاعدة البيانات بنمط Modular Monolith"] },
  ...
  { v: "2.9.0", date: "2025-08-20", tag: "ميزات جديدة", items: ["إضافة سندات التحويل بين المخازن مع تسعير تلقائي", "حدود ائتمانية للعملاء مع تنبيهات فورية", "تصدير التقارير إلى Excel وPDF بضغطة واحدة"] },
  ...
  { v: "2.8.0", date: "2025-02-27", tag: "ميزات جديدة", items: ["دليل حسابات هرمي من 5 مستويات", "إقفال الفترات المالية مع حماية الكتابة", "شاشة تفضيلات متكاملة (خطوط، اتجاه، تنسيقات)"] },
];
